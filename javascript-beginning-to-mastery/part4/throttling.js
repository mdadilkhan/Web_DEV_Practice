//! What is Throttling?
//? Throttling is a technique used to limit the exuecution of a function in given period of time  even when the event triggering continuosly done by user
...
function customThrottling(func,limit){
  let lastCall=0;
...
//    window.addEventListener('resize',showDimensions);// without throtling 
  window.addEventListener('resize', customThrottling(showDimensions, 5000));
